...
public class UploadService extends Service {
    ...
    public static final String UPLOAD_PROGRESS_ACTION = "igarape.cbmsc.bombcast.UPLOAD_PROGRESS";
    public static final String FILE_SIZE = "FILE_SIZE";
    public static final String CANCEL_UPLOAD_ACTION = "igarape.cbmsc.bombcast.CANCEL_UPLOAD";
    public static final String COMPLETED_UPLOAD_ACTION = "igarape.cbmsc.bombcast.COMPLETED_UPLOAD";
    private int mId = 3;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        this.intent = intent;
        final Intent resultIntent = new Intent(this, Select_Vtr_Activity.class);
        ...
        stackBuilder.addParentStack(Select_Vtr_Activity.class);
    ...
    private void uploadVideo(final File nextVideo, final String userLogin) {
        ...
        if (nextVideo.exists()) {
            ...
            NetworkUtils.post(getApplicationContext(), Globals.SERVER_CBM + "receive_video.php", params, nextVideo, new HttpResponseCallback() {
